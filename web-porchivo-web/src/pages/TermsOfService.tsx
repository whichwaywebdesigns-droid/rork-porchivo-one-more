    ...
    <PageLayout>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mt-8 mb-12 pb-8 border-b border-brand-navy-500/50">
          ...
          <h1 className="text-4xl font-bold text-brand-text-primary mb-3">Terms of Service</h1>
        ...
        <div className="bg-brand-navy-800/60 border border-brand-navy-500/50 rounded-xl p-6 mb-10 text-brand-text-secondary leading-relaxed">
          <p>
            Welcome to <strong className="text-brand-text-primary">Porchivo</strong>, a community management platform
            developed and operated by <strong className="text-brand-text-primary">{COMPANY}</strong> ("Company," "we,"
        ...
        <Section number="9" title="No Vetting, Background Checks, or Endorsement">
          <div className="bg-brand-navy-700/50 border border-brand-navy-500/60 rounded-lg p-4 text-sm uppercase tracking-wide leading-relaxed">
        ...
        <Section number="12" title="No Affiliation With Carriers or Suppliers">
          ...
          <div className="bg-brand-orange/10 border border-brand-orange/20 rounded-lg p-4 mt-4 text-brand-orange-light">
        ...
        <Section number="17" title="Limitation of Liability">
          <div className="bg-brand-navy-700/50 border border-brand-navy-500/60 rounded-lg p-4 text-sm uppercase tracking-wide leading-relaxed space-y-3">
            <p>
              ...
              <tbody className="text-brand-text-secondary">
                ...
                <tr className="border-t border-brand-navy-500/50">
                  ...
                  <td className="px-4 py-2">
                    <a href="mailto:support@porchivo.com" className="text-brand-orange hover:text-brand-orange-light transition-colors">
        ...
        <Section number="26" title="Contact Us">
          ...
          <div className="bg-brand-navy-700 border border-brand-navy-500/50 rounded-xl p-5 mt-4 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-brand-text-primary font-semibold">{COMPANY}</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-brand-orange">✉️</span>
              <a href="mailto:support@porchivo.com" className="text-brand-text-secondary hover:text-brand-orange transition-colors">
                support@porchivo.com
              </a>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-brand-orange">📍</span>
              <span className="text-brand-text-secondary">Indianapolis, Indiana, United States</span>
            </div>
          </div>
        </Section>
