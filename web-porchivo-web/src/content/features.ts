...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    aiSummary:
      "Community plans allow HOAs and property managers to unlock all Porchivo features for their residents. Plans start at $79/mo (Starter, 50 units) and scale to $599/mo (Enterprise, 2,000 units). Residents always join for free via invite code. Annual billing saves 20%.",
    facts: [
  ...
  },
  {
    ...
    description:
      "Porchivo offers four B2B tiers: Starter ($79/mo, 50 units), Community ($199/mo, 200 units), Professional ($399/mo, 500 units), and Enterprise ($599/mo, 2,000 units). All plans include package tracking, theft alerts, and community features for every resident. Professional and Enterprise tiers include multi-community dashboards, vendor management, custom branding, API access, and dedicated support.",
    aiSummary:
      "Porchivo offers four B2B community tiers: Starter ($79/mo, 50 units), Community ($199/mo, 200 units), Professional ($399/mo, 500 units), and Enterprise ($599/mo, 2,000 units). Annual billing saves 20%. Residents always join for free. Professional includes $500 onboarding; Enterprise includes $1,500 onboarding and dedicated account manager.",
    facts: [
