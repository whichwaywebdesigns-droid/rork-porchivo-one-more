...
export function sendHoaPilotWelcome(client: SqlRpcClient, p: HoaPilotPayload) {
  return enqueueTemplateEmail(client, {
    ...
    variables: {
      ...
      hoa_dashboard_url: `${WEB_BASE}/app`,
    },
    sourceTable: 'organizations',
    sourceId: null,
  });
