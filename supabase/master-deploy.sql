...
--
-- Bundles 53 migrations in dependency order.
-- =============================================================
...
-- #############################################################
-- ##  email-spanish-templates-migration.sql
-- #############################################################
-- ═══════════════════════════════════════════════════════════════════════════
...
-- #############################################################
-- ##  onboarding-fee-msi-migration.sql
-- #############################################################
-- ═══════════════════════════════════════════════════════════════════════════
...
DROP POLICY IF EXISTS billing_event_log_no_client_access ON public.billing_event_log;
CREATE POLICY billing_event_log_no_client_access
    ON public.billing_event_log FOR ALL TO anon, authenticated
    USING (false) WITH CHECK (false);

DROP POLICY IF EXISTS billing_event_alerts_no_client_access ON public.billing_event_alerts;
...
DROP TRIGGER IF EXISTS billing_event_log_outcome_guard ON public.billing_event_log;
...
DROP TRIGGER IF EXISTS billing_event_alerts_immutable ON public.billing_event_alerts;
