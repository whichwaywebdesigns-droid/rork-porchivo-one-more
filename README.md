...
_Last refreshed: **2026-08-06 11:35 UTC** — generated by `scripts/refresh-docs.mjs`._

**At a glance**

| Area | Count |
|------|------:|
| Mobile screens (`expo/app/`) | 75 |
| Mobile components (`expo/components/`) | 55 |
| Shared libs (`expo/lib/`) | 30 |
