...
_Last refreshed: **2026-08-03 17:16 UTC** — generated by `scripts/refresh-docs.mjs`._

**At a glance**

| Area | Count |
|------|------:|
| Mobile screens (`expo/app/`) | 73 |
...
**Current screens:** `activity-history`, `add-package`, `add-property`, `admin-dashboard`, `admin-funnel`, `alert-detail`, `alerts`, `analytics-dashboard`, `announcements`, `billing`, `chat`, `community-calendar`, `community-guidelines`, `contact-support`, `create-assignment`, `create-event`, `delivery-alerts`, `delivery-windows`, `drivers`, `edit-profile`, `field-guide`, `file-incident`, `guest-browse`, `how-it-works`, `incident-queue`, `invite-partner`, `invoices`, `join-community`, `location-consent`, `log-package`, `login`, `maintenance-queue`, `map`, `my-assignments`, `neighborhood`, `network-map`, `notifications`, `notifications-permission`, `onboarding-paywall`, `onboarding-setup`, `package-detail`, `package-ops-board`, `pain-point`, `partner-detail`, `partner-earnings`, `partner-holds`, `partner-onboarding`, `partner-payout-setup`, `partner-verify`, `partners`, `porch-risk`, `post-announcement`, `privacy-policy`, `property-management`, `referral`, `reset-password`, `resident-directory`, `role-management`, `role-selection`, `safe-dropoff`, `safety-score`, `settings`, `shipment-detail`, `staff-support-queue`, `submit-maintenance`, `support-ticket-detail`, `terms-of-service`, `trust-engine`, `upgrade`, `value-preview`, `welcome`, `welcome-features`, `win-back`
